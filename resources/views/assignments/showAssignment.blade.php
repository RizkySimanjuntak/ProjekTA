    ...
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    <p class="mb-2">{!! nl2br(e($assignment->description)) !!}</p>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $submission && $submission->grade ? 'Graded ('.$submission->grade.')' : 'Not graded' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                {{-- <td>Comments ({{ $submission ? $submission->comments->count() : 0 }})</td> --}}
                            </tr>
                        </tbody>
                    </table>
                </div>
