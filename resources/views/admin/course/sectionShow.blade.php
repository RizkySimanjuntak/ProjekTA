                ...
                <div class="card-body">
                    <ul class="list-group">
                        @foreach($section->sub_topic as $subTopic)
                                            ...
                                            <ul class="list-group">
                                                ...
                                                @endforeach
                                                    ...
                                                    {{-- @foreach($subTopic->assignments as $assignment)
                                                        <li class="list-group-item">
                                                            {!! $assignment->name !!}
                                                            <div class="badge bg-info">Opened: {{ $assignment->created_at }}</div>
                                                            <div class="badge bg-info">Due date: {{ $assignment->due_date }}</div>
                                                        </li>
                                                    @endforeach --}}
                            ...
                            @forelse($subTopic->assignments as $assignment)
                                <li class="list-group-item">

                                    <a href="{{ route('assignments.showAssignment', $assignment->id) }}"><i class="bi bi-file-text me-2"></i> {!! $assignment->name !!}</a>
                                                ...
                                                <div class="tab-content" id="myTabContent{{ $subTopic->id }}">
                                                    ...
                                                    <div class="tab-pane fade" id="knowledge{{ $subTopic->id }}" role="tabpanel" aria-labelledby="knowledge-tab{{ $subTopic->id }}">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 text-center mb-3">
                                                                <button class="btn btn-outline-primary w-100">
                                                                    <a href={{ route('files.create', ['sub_topic_id' => $subTopic->id]) }}></a><i class="bi bi-file-earmark fs-3"></i><br>File
                                                                </button>
                                                            </div>
                                                            <div class="col-4 text-center mb-3">
                                                                <button class="btn btn-outline-primary w-100">
                                                                    <a href={{ route('pages.create', ['sub_topic_id' => $subTopic->id]) }}></a><i class="bi bi-file-earmark-richtext fs-3"></i><br>Page
                                                                </button>
                                                            </div>
                                                            <div class="col-4 text-center mb-3">
                                                                <button class="btn btn-outline-primary w-100">
                                                            ...
                                                            <div class="col-4 text-center mb-3">
                                                                <button class="btn btn-outline-primary w-100">
                                                                    <a href={{ route('infografis.create', ['sub_topic_id' => $subTopic->id]) }}></a><i class="bi-pie-chart"></i><br>Infografis
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
